public class Main {
    ...
    public static void main(String[] args) {
        ...
        Atleta atleta1 = new Atleta(201, "João Silva", "123456789");
        Atleta atleta2 = new Atleta(202, "Maria Oliveira", "987654321");
        ...
        gerenciador.getAtletas().add(atleta1);
        gerenciador.getAtletas().add(atleta2);
